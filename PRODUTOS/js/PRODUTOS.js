...
// Gerencia um carrinho virtual, adicionando produtos com base nos atributos data-* dos cartões ao clicar nos botões '.js-add-to-cart'.
...
// //     });
// //   });
  //                                ACHO QUE ISSO NAO É UTILIZADO
// });

  
  // // Aplica uma animação ao botão '.btn-adquirir-animado' ao ser clicado, com duração de 800ms.
...
// SUGESTAO DO CHAT PRA FZR ISSO. 
//            FUNCIONA DO MESMO JEITO, SO QUE O CARRINHO NAO FICA ZERADO. SO DEIXEI PRA TU VER. 
  ...
  //   button.addEventListener('click', function (event) {
  //     event.preventDefault(); // Previne a ação padrão do link
  //     toastInstance.show(); // Exibe a notificação
  //     cartCount += 1; // Atualiza o contador
  //     cartBadge.innerText = cartCount;
  //     localStorage.setItem('cartCount', cartCount); // Persiste no localStorage
  //   });
  // });